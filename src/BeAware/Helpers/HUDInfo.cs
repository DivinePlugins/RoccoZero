...
public static class HUDInfo
{
    ...
    private static float MapBottom { get; } = -8742; // 8742 - patch 7.33 bigger map (Twin Gates. etc.)

    internal static float MapLeft { get; } = -8742;

    internal static float MapRight { get; } = 8742;

    internal static float MapTop { get; } = 8742;
    ...
    public static Vector2 WorldToMinimap(Vector3 mapPosition)
    {
